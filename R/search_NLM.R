...
#' @param plot plot diagnostic plots
#'
#' @export
#'
search_NLM <-  function(file = NULL,type = 'SIM', raw = FALSE, delta_search_mass = NULL, search_name = "",scandef_file = NULL, sim_width = NULL,overlapMZ = NULL,ppm_tol = 20, rt_tol = 9,mzmin = 135,mzmax = 634,mzwid = 0.01, plot = F){
  ...
  assign("mzmin", mzmin, envir = .GlobalEnv)
  
  assign("mzmax", mzmax, envir = .GlobalEnv)
